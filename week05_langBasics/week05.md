...
> #### 示例：选择器
> [`examples/sec02_css/00_selector.html`](http://htmlpreview.github.io/?https://github.com/ShanghaitechGeekPie/events-IntroToWebDev-Fall17/blob/master/week05_langBasics/examples/sec02_css/00_selector.html) 演示了选择器对应语句的效果

> #### 示例：盒模型
> [`examples/sec02_css/01_box_model.html`](http://htmlpreview.github.io/?https://github.com/ShanghaitechGeekPie/events-IntroToWebDev-Fall17/blob/master/week05_langBasics/examples/sec02_css/01_box_model.html) 演示了盒模型对应语句的视觉效果

> #### 示例：响应式布局
> [`examples/sec02_css/02_responsive.html`](http://htmlpreview.github.io/?https://github.com/ShanghaitechGeekPie/events-IntroToWebDev-Fall17/blob/master/week05_langBasics/examples/sec02_css/02_responsive.html) 演示了响应式布局的一种实现

> #### 示例：过渡动画
> [`examples/sec02_css/03_transition.html`](http://htmlpreview.github.io/?https://github.com/ShanghaitechGeekPie/events-IntroToWebDev-Fall17/blob/master/week05_langBasics/examples/sec02_css/03_transition.html) 演示了过渡动画

> #### 示例：关键帧动画
> [`examples/sec02_css/04_key_frame.html`](http://htmlpreview.github.io/?https://github.com/ShanghaitechGeekPie/events-IntroToWebDev-Fall17/blob/master/week05_langBasics/examples/sec02_css/04_key_frame.html) 演示了关键帧动画

> #### 示例：布局技巧
> [`examples/sec02_css/05_positioning.html`](http://zh.learnlayout.com/index.html) 跳转到的[学习 CSS 布局](http://zh.learnlayout.com/index.html)演示了各类布局示例，如固定在页面顶端、在页面中垂直居中等
...
> #### 示例：操作页面元素
> [`examples/sec03_js/00_dom_manipulation.html`](http://htmlpreview.github.io/?https://github.com/ShanghaitechGeekPie/events-IntroToWebDev-Fall17/blob/master/week05_langBasics/examples/sec03_js/00_dom_manipulation.html) 演示了使用 JS 完成的 DOM 操作，以及如何添加事件监听器（Event Listener）。

> #### 示例：定时
> [`examples/sec03_js/01_settimeout.html`](http://htmlpreview.github.io/?https://github.com/ShanghaitechGeekPie/events-IntroToWebDev-Fall17/blob/master/week05_langBasics/examples/sec03_js/01_settimeout.html) 演示了`setTimeOut`实现的定时功能，和`setInterval`实现的周期定时功能
> 在 [Google 开发者社区]https://developers.google.com/web/fundamentals/performance/rendering/optimize-javascript-execution 可以阅读到其他可以实现时序视觉变化的方法

> #### 示例：jQuery
> [`examples/sec03_js/02_jquery.html`](http://htmlpreview.github.io/?https://github.com/ShanghaitechGeekPie/events-IntroToWebDev-Fall17/blob/master/week05_langBasics/examples/sec03_js/02_jquery.html) 演示了经典的基于`jQuery`的 DOM 操作
